...
- [Download](https://github.com/eur0pa/ffuf/releases/latest) a prebuilt binary from [releases page](https://github.com/eur0pa/ffuf/releases/latest), unpack and run!
  ...
  _or_
- If you have recent go compiler installed: `go get -u github.com/eur0pa/ffuf` (the same command works for updating)
  
  _or_
- git clone https://github.com/eur0pa/ffuf ; cd ffuf ; go get ; go build 
...
found [here](https://github.com/eur0pa/ffuf/blob/master/ffufrc.example). 
...
EXAMPLE USAGE:
  ...
  More information and examples: https://github.com/eur0pa/ffuf
...
See [ffuf-scripts](https://github.com/eur0pa/ffuf-scripts) repository for helper scripts and payload generators
for different workflows and usage scenarios.

## License

ffuf is released under MIT license. See [LICENSE](https://github.com/eur0pa/ffuf/blob/master/LICENSE).
